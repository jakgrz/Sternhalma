            ...
            for (int j = 0; j < 25; ++j) {
                ...
                if (i == 0) {
                    ...
                    if (j % 2 == 0) {
                        if (j < 7) {
                            if (players == 6) {
                                setField(i, j, new Pawn(6),true);
                            } else {
                                setField(i, j, null,true);
                            }
                        } else if (j > 17) {
                            if (players == 4 || players == 6) {
                                setField(i, j, new Pawn(2),true);
                            } else {
                                setField(i, j, null,true);
                            }
                        } else {
                    ...
                    if (j % 2 == 1 && j != 1 && j != 23) {
                        if (j < 5) {
                            if (players == 3) {
                                setField(i, j, new Pawn(3),true);
                            } else if (players == 4) {
                                setField(i, j, new Pawn(4),true);
                            } else if (players == 6) {
                                setField(i, j, new Pawn(5),true);
                            } else {
                                setField(i, j, null,true);
                            }
                        } else if (j > 19) {
